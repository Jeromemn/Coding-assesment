...
const questions = [
  ...
  {
    question:
      " What is the only primitive type that must be surrounded by quotes?",
    choices: ["a", "Strings", "c", "d"],
    answer: "Strings",
  },
  {
    question:
      "Which primitive type would we use if we wanted to store a decimal or an integer?",
    choices: ["Numbers", "b", "c", "d"],
    answer: "Numbers",
  },
  {
    question:
      "What does an expression using a logical or comparison operator evaluate to?",
  ...
  },
  {
    ...
    choices: [
      ...
      "b",
      "c",
      "It specifies whether the flex items should wrap or not. The value can be set to nowrap, wrap-reverse, or wrap.",
    ],
    answer:
      "It specifies whether the flex items should wrap or not. The value can be set to nowrap, wrap-reverse, or wrap.",
  },
  ...
  {
    question:
      "What property can we use to determine the total number of elements in an array?",
  ...
  {
    question:
      "How do we get stored data to appear on the page when we open a browser window?",
    choices: [
  ...
  {
    question:
      "What is the difference between an if statement and an else statement?",
    choices: [
      "a",
      "b",
      "c",
...
function displayScoreBoard() {
  ...
  // Gets current highscores from local storage
  const currentHighScores = JSON.parse(localStorage.getItem("highscores"));
  // If no current high scores, then dont render high scores
